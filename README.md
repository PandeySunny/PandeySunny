...
class SunnyPandey:
    name        = "Sunny Pandey"
    role        = ["Data Engineer", "BI Developer", "Data Analyst", "Aspiring Data Scientist"]
    education   = "B.Tech Computer Engineering · 8th Semester · India 🇮🇳"
    currently   = ["Data Engineering", "Automation", "Cloud Data Pipelines"]
    learning    = ["Machine Learning", "AI", "Cloud Data Engineering (AWS / Azure / GCP)"]
    interests   = ["ETL", "Data Warehousing", "Predictive Analytics", "Business Intelligence"]
    philosophy  = "I see databases like a vast sea — always diving deeper 🌊"
    open_to     = "Internships · Full-time · Collaborations"
    ask_me      = ["Python", "SQL", "ETL Pipelines", "Data Modeling", "BI"]
```
...
<img src="https://skillicons.dev/icons?i=python,mysql,postgresql,aws,git,github,linux,vscode&theme=dark" />
...
<img src="https://github-readme-stats.vercel.app/api?username=PandeySunny&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=00d4aa&icon_color=7c3aed&text_color=e6edf3&border_radius=12&include_all_commits=true&count_private=true" height="180" />
&nbsp;&nbsp;
